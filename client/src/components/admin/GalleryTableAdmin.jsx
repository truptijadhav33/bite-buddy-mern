...
import { fetchGalleryItems, createGalleryItem, deleteGalleryItem } from "../../slices/gallerySlice";
...
export default function GalleryTableAdmin() {
    ...
    const addItem = (e) => {
        ...
        setNewItem({ title: "", category: "Other", image: "", description: "" });
    };
            ...
            <div className="relative w-full overflow-auto">
                    ...
                    <tbody className="divide-y divide-white/5">
                        {items.map((item) => (
                            <tr key={item._id} className="hover:bg-white/5 transition-colors group">
                                ...
                                <td className="p-6 align-middle">
                                    <Badge className="bg-white/10 text-white border-white/10 font-bold uppercase tracking-tighter text-[10px]">
                                        {item.category}
                                    </Badge>
                                </td>
                ...
                {items.length === 0 && !loading && (
                    <div className="py-20 text-center text-muted-foreground italic">
                        Gallery is empty. Show us your best moments.
                    </div>
                )}
            </div>
        </div>
